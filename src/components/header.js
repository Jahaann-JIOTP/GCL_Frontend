  ...
  return (
    <header className="bg-[#1F5897] text-white mx-0 my-2 mt-0 flex text-sm w-full">
      ...
      >
        <Link  className={`py-[8px] px-4`} href="/dashboard" onClick={() => handleTabClick("Home")}>
          <p
             className={`px-3 py-1 cursor-pointer rounded-lg flex gap-1 ${
              pathname === "/dashboard" || pathname === "/status_table" ? "bg-white text-black" : ""
            }`}
          >
            <FontAwesomeIcon
              icon={faDashboard}
        ...
        <Link className={`py-[8px] px-4`} href="#" onClick={() => handleTabClick("Alarms")}>
          <p
            className={`px-3 py-1 cursor-pointer rounded-lg flex gap-1 ${
        ...
        {/* <Link className="py-2 px-1" href="#" onClick={() => handleTabClick("Setting")}>
          <p
            className={`px-3 py-1 cursor-pointer rounded-lg flex gap-1 ${
