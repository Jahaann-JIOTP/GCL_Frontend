...
const MeterDataComponent = () => {
  ...
  const getHrefForAction = () => `/Logs?type=${activeTab}&&id=${id}&&meter=${meter}`;
  ...
  const renderTagsWithPosition = () => {
    ...
    const tagPositions =
      activeTab === "volts"
        ...
        VOLTAGE_LINE_1_V: {  left: "62pt", top: "157pt", unit: "V ca" },
        VOLTAGE_LINE_2_V: { left: "168pt", top: "118pt", unit: "V bc" },
        VOLTAGE_LINE_3_V: { left: "170pt", top: "188pt", unit: "V ab"  },
        VOLTAGE_L_N_AVG_V: { left: "165pt", top: "372pt", unit: "V"  },
        VOLTAGE_LINE_1_2_V: {  left: "522pt", top: "316pt", unit: "V AN" },
        VOLTAGE_LINE_2_3_V: { left: "622pt", top: "316pt", unit: "V BN"  },
        VOLTAGE_LINE_3_1_V: {left: "724pt", top: "316pt", unit: "V CN" },
        VOLTAGE_L_L_AVG_V: { left: "838pt", top: "341pt", unit: "V" },
        ...
        REACTIVE_POWER_TOTAL_KVAR: { left: "400pt", top: "330pt", unit: "kVAR" },
        APPARENT_POWER_TOTAL_KVA: { left: "400pt", top: "372pt", unit: "kVA" },
    ...
    <div className="flex-shrink-0 w-full p-6 h-[85vh] rounded-[8px] bg-[#fff] border-2 border-[grey] border-t-[4px] border-t-[#1d5999] relative">
      ...
      <div className="relative w-[1500px] h-[600px]">
        <img
          ...
          useMap="#workmap"
        />
       <Link href="/sld"><img src="back.jpg" className="absolute top-[41px] left-[1056px] h-[57px] border-transparent rounded-3xl" /></Link>
        {/* Unified Map */}
        <map name="workmap">
          {/* Tab Switching Areas */}
          <area
