...
function DashboardPage() {
  ...
  useEffect(() => {
    const fetchSolarData = () => {
      const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans.php?start_date=${solarStartDate}&end_date=${solarEndDate}`;
      fetch(apiUrl)
  ...
  useEffect(() => {
    const fetchTransformerData = () => {
      const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans.php?start_date=${transformerStartDate}&end_date=${transformerEndDate}`;
      fetch(apiUrl)
        .then((response) => response.json())
        .then((data) => {
          if (data && data.total_consumption) {
  ...
  useEffect(() => {
    const fetchTransformer1Data = () => {
      const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans.php?start_date=${transformer1StartDate}&end_date=${transformer1EndDate}`;
      fetch(apiUrl)
        .then((response) => response.json())
        .then((data) => {
          if (data && data.total_consumption) {
  ...
  useEffect(() => {
    const fetchAll_GensetData = () => {
      const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans.php?start_date=${All_GensetStartDate}&end_date=${All_GensetEndDate}`;
      fetch(apiUrl)
        .then((response) => response.json())
        .then((data) => {
          if (data && data.total_consumption) {
  ...
  useEffect(() => {
    const fetchAll_ConsumptionData = async () => {
      const apiUrl = `https://www.gclapi.jiotp.com/total_consumption.php?start_date=${All_ConsumptionStartDate}&end_date=${All_ConsumptionEndDate}`;
  ...
  useEffect(() => {
    const fetchAll_productionData = async () => {
      const apiUrl = `https://www.gclapi.jiotp.com/unaccoutable_energy.php?start_date=${All_productionStartDate}&end_date=${All_productionEndDate}`;
      console.log("Fetching:", apiUrl);
  ...
  useEffect(() => {
    const fetchAll_energyData = async () => {
      const apiUrl = `https://www.gclapi.jiotp.com/unaccoutable_energy.php?start_date=${All_energyStartDate}&end_date=${All_energyEndDate}`;
      console.log("Fetching:", apiUrl);
  ...
  useEffect(() => {
    const createProductionChart = async () => {
      ...
      if (chartContainer) {
        ...
        const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans_com.php?start_date=${startDate}&end_date=${endDate}&label=${timePeriod}`;
    ...
    const createSolarPieChart = async () => {
      ...
      if (chartContainer) {
        ...
        try {
          ...
          const apiUrl = `https://www.gclapi.jiotp.com/pie_api.php?start_date=${formattedStartDate1}&end_date=${formattedEndDate1}&meterId=G2_U20,U_27&suffixes=ACTIVE_ENERGY_IMPORT_KWH`;
          const response = await axios.get(apiUrl);
    ...
    const createTransformerPieChart = async () => {
      ...
      if (chartContainer) {
        ...
        try {
          const formattedStartDate1 = startDate1.toISOString().split("T")[0];
          const formattedEndDate1 = endDate1.toISOString().split("T")[0];
          const apiUrl = `https://www.gclapi.jiotp.com/pie_api.php?start_date=${formattedStartDate1}&end_date=${formattedEndDate1}&meterId=U_24,U_25&suffixes=ACTIVE_ENERGY_IMPORT_KWH`;
          const response = await axios.get(apiUrl);
    ...
    const createSolarsVsTransformersChart = async () => {
      ...
      if (chartContainer) {
        ...
        try {
          const formattedStartDate1 = startDate1.toISOString().split("T")[0];
          const formattedEndDate1 = endDate1.toISOString().split("T")[0];
          const apiUrl = `https://www.gclapi.jiotp.com/solar_vs_trans.php?start_date=${formattedStartDate1}&end_date=${formattedEndDate1}`;
          const response = await axios.get(apiUrl);
  ...
  const fetchChartData1 = async (value) => {
    ...
    const apiUrl1 = `https://www.gclapi.jiotp.com/total_consumption_pp.php?value=${value}`;
  ...
  // API Endpoints
  const categoryApis = {
    "Solar Generation": "https://www.gclapi.jiotp.com/solar_pp.php?value=",
    Genset: "https://www.gclapi.jiotp.com/Genset_pp.php?value=",
    Transformer: "https://www.gclapi.jiotp.com/transformer_pp.php?value=",
  };
